...
namespace Prekenweb.Models.Identity
{
    ...
    { 
        ...
        [Display(Name = "Naam", ResourceType = typeof(Resources.Resources)), Required(AllowEmptyStrings = false)]
        public string Naam { get; set; }

        [Display(Name = "LaatstIngelogd", ResourceType = typeof(Resources.Resources))]
    ...
    {
        [DataType(DataType.EmailAddress), EmailAddress(ErrorMessage = "Geen juist emailadres"), Display(Name = "Email", ResourceType = typeof(Resources.Resources)), Required(AllowEmptyStrings = false)]
        public string Email { get; set; }

        [Display(Name = "Gebruikersnaam", ResourceType = typeof(Resources.Resources)), Required(AllowEmptyStrings = false)]
