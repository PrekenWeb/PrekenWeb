...
namespace Prekenweb.Models
{
    ...
    { 
        ...
        [UIHint("Bijbeltekst"), Display(Name = "BijbeltekstOmschrijving", ResourceType = typeof(Resources.Resources)), DataType(DataType.MultilineText), Tooltip("Maak gebruik van blokhaken om een versnummer te markeren, bijvoorbeeld:<br/>[1] In den beginne...")]
        public string BijbeltekstOmschrijving { get; set; }

        [UIHint("Serie"), Display(Name = "Serie", ResourceType = typeof(Resources.Resources))]
        ...
        [Display(Name = "Bestand", ResourceType = typeof(Resources.Resources)), DataType(DataType.Upload)]
        public string Bestandsnaam { get; set; }

        [Display(Name = "AantalKeerGedownload", ResourceType = typeof(Resources.Resources))]
        public int AantalKeerGedownload { get; set; }

        public int? OudId { get; set; }

        [Required(ErrorMessage = "Predikant is verplicht"), UIHint("Predikant"), Display(Name = "Predikant", ResourceType = typeof(Resources.Resources))]
        public int? PredikantId { get; set; }

        [Display(Name = "Hoofdstuk", ResourceType = typeof(Resources.Resources))]
        public int? Hoofdstuk { get; set; }

        [Display(Name = "VanVers", ResourceType = typeof(Resources.Resources))]
        public string VanVers { get; set; }

        [Display(Name = "TotVers", ResourceType = typeof(Resources.Resources))]
        public string TotVers { get; set; }

        [Display(Name = "Punt1", ResourceType = typeof(Resources.Resources))]
        public string Punt1 { get; set; }

        [Display(Name = "Punt2", ResourceType = typeof(Resources.Resources))]
        public string Punt2 { get; set; }

        [Display(Name = "Punt3", ResourceType = typeof(Resources.Resources))]
        public string Punt3 { get; set; }

        [Display(Name = "Punt4", ResourceType = typeof(Resources.Resources))]
        public string Punt4 { get; set; }

        [Display(Name = "Punt5", ResourceType = typeof(Resources.Resources))]
        public string Punt5 { get; set; }

        [UIHint("Gemeente"), Display(Name = "Gemeente", ResourceType = typeof(Resources.Resources))]
        public int? GemeenteId { get; set; }

        [DataType(DataType.DateTime), Display(Name = "GepreektOp", ResourceType = typeof(Resources.Resources)), DisplayFormat(DataFormatString = "{0:d}")]
        public DateTime? DatumPreek { get; set; }

        [DataType(DataType.MultilineText), Display(Name = "OverigeInformatie", ResourceType = typeof(Resources.Resources))]
        public string Informatie { get; set; }

        [Display(Name = "Thema", ResourceType = typeof(Resources.Resources))]
        public string ThemaOmschrijving { get; set; }

        public int? AfbeeldingId { get; set; }

        [Required(ErrorMessage = "Preek type is verplicht"), UIHint("PreekType"), Display(Name = "PreekType", ResourceType = typeof(Resources.Resources))]
        public int PreekTypeId { get; set; }

        [UIHint("LezingCategorie"), Display(Name = "LezingCategorie", ResourceType = typeof(Resources.Resources))]
        ...
        [Display(Name = "Gepubliceerd", ResourceType = typeof(Resources.Resources))]
        public bool Gepubliceerd { get; set; }

        [UIHint("LezingOmschrijving"), Display(Name = "LezingOmschrijving", ResourceType = typeof(Resources.Resources))]
        ...
        [UIHint("Vers"), Display(Name = "VanVersId", ResourceType = typeof(Resources.Resources)), Tooltip("VersVanIdTooltip", ResourceType = typeof(Resources.Resources))]
        public int? VersVanId { get; set; }

        [UIHint("Vers"), Display(Name = "TotVersId", ResourceType = typeof(Resources.Resources)), Tooltip("VersTotIdTooltip", ResourceType = typeof(Resources.Resources))]
        ...
        [Display(Name = "VersOmschrijving", ResourceType = typeof(Resources.Resources)), Tooltip("VersOmschrijvingTooltip", ResourceType = typeof(Resources.Resources))]
        public string VersOmschrijving { get; set; }

        [Display(Name = "AutomatischeTeksten", ResourceType = typeof(Resources.Resources))]
        public bool AutomatischeTeksten { get; set; }

        [UIHint("Gebruiker"), Display(Name = "AangemaaktDoor", ResourceType = typeof(Resources.Resources))]
        public int? AangemaaktDoor { get; set; }

        [UIHint("Gebruiker"), Display(Name = "AangepastDoor", ResourceType = typeof(Resources.Resources))]
        public int? AangepastDoor { get; set; }

        [Display(Name = "LeesPreekTekst", ResourceType = typeof(Resources.Resources)), DataType(DataType.Html), Tooltip("LeesPreekTekstTooltip", ResourceType = typeof(Resources.Resources))]
        ...
        [Display(Name = "Categorie", ResourceType = typeof(Resources.Resources))]
        ...
        public string GetPreekTitel()
        {
            ...
            if (Predikant != null)
            {
                titel += string.Format(" {0} ", Resources.Resources.Uit);
        ...
        public string GetBoekhoofdstukOmschrijving()
        {
            ...
            {
                boekhoofdstukOmschrijving += string.Format(" {0} {1:d}", Resources.Resources.Op, DatumPreek.Value);
            }
        ...
        public string GetPreekOmschrijvingITunes()
        {
            ...
            if (!string.IsNullOrEmpty(ThemaOmschrijving)) omschrijving += string.Format(" {0}: {1}", Resources.Resources.Thema, ThemaOmschrijving);
            if (!string.IsNullOrEmpty(Punt1)) omschrijving += string.Format(" {0}: {1}", Resources.Resources.Punt1, Punt1);
            if (!string.IsNullOrEmpty(Punt2)) omschrijving += string.Format(", {0}: {1}", Resources.Resources.Punt2, Punt2);
            if (!string.IsNullOrEmpty(Punt3)) omschrijving += string.Format(", {0}: {1}", Resources.Resources.Punt3, Punt3);
            if (!string.IsNullOrEmpty(Punt4)) omschrijving += string.Format(", {0}: {1}", Resources.Resources.Punt4, Punt4);
            if (!string.IsNullOrEmpty(Punt5)) omschrijving += string.Format(", {0}: {1}", Resources.Resources.Punt5, Punt5);
            if (!string.IsNullOrEmpty(BijbeltekstOmschrijving)) omschrijving += string.Format(", {0}: {1}", Resources.Resources.BijbeltekstOmschrijving, BijbeltekstOmschrijving);

            return omschrijving.Replace("  ", " ").TrimStart(',').TrimEnd(',').Trim();
        }

        [NotMapped, Display(Name = "AankondigingenBord", ResourceType = typeof(Resources.Resources)), Tooltip("AankondigingenBordTooltip", ResourceType = typeof(Resources.Resources))]
